            ...
            <form id="formSubmit">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">اللون</label>
                                <select id="btn_color" name="btn_color" class="form-control"   >
                                    <option value="btn btn-primary" class="text-primary">ازرق</option>
                                    <option value="btn btn-danger" class="text-danger">احمر</option>
                                    <option value="btn btn-success" class="text-success">اخضر</option>
                                </select>
                            </div>
                        </div>
